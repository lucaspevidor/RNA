...
class RedeNeural:
    ...
    def set_entradas_ant(self, entradas, normalizar):        
        if normalizar:                
            self.entradas = self.normalizar(entradas, False)
        else:
    ...
    def set_entradas_pós(self, entradas, normalizar):
        if normalizar:            
            self.entradas = self.normalizar(entradas, True)
        else:
            self.entradas = entradas
